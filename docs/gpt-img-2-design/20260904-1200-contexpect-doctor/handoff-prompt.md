...
I have a complete image-based UI design pack at ./docs/gpt-img-2-design/20260904-1200-contexpect-doctor. Please read every markdown file and every image in that folder before editing code.
...
When done, update ./docs/gpt-img-2-design/20260904-1200-contexpect-doctor/06-implementation-plan.md with what was implemented, verification screenshots, remaining differences, and follow-up risks. Commit and push only if I explicitly ask for that in this task.
