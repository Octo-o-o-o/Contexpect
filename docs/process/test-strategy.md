...
| ui-unit | `packages/ui` | `pnpm test`（`node --test tests/routes.test.mjs tests/i18n.test.mjs tests/mask.test.mjs tests/page-state.test.mjs tests/settings-form.test.mjs tests/contrast.test.mjs`） | Node ≥22，pnpm 11.20.0 |
